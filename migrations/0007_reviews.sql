...
INSERT INTO reviews (name,initial,rating,treatment,source,text,status,featured,sort_order,created_at) SELECT 'Amelia','A',5,'Laser Hair Removal','Client feedback','Fantastic experience with Iulia.','approved',0,10,'2026-07-21T00:00:00Z' WHERE NOT EXISTS (SELECT 1 FROM review_meta WHERE key='reviews_seeded');
